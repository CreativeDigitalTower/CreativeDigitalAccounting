...
import { hasFashionAccess } from "@/lib/fashion/access";
...
export default async function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  const [company, me, jar, sub, inboxUnread, logisticsEnabled, fashionEnabled, myCompanyRows] = await Promise.all([
    ...
    hasFashionAccess(companyId).catch(() => false),
