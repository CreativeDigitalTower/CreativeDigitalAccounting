  ...
  return (
    <div style={{ maxWidth: 1000 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 12, flexWrap: "wrap" }}>
        ...
        {inv.direction === "received" && <Link href="/dashboard/logistics/mk-sales" className="btn btn-primary btn-sm" style={{ marginLeft: "auto" }}>{t("logistics.mksale.createSaleFrom")}</Link>}
      </div>
