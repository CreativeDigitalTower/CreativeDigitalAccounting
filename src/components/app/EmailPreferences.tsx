  ...
  return (
    <div className="glass panel" style={{ padding: "24px 28px", marginBottom: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 4 }}>
        <h2 style={{ fontFamily: "'Fraunces', serif", fontSize: 17, fontWeight: 600, margin: 0 }}>Имейл известия</h2>
        {saved && <span style={{ fontSize: 12, color: "var(--emerald-dark)" }}>Запазено ✓</span>}
      </div>
      <p style={{ fontSize: 12.5, color: "var(--muted)", margin: "0 0 16px" }}>
        Изберете кои автоматични имейли да получавате. Имейлите за сигурност (парола, вход) се изпращат винаги.
      </p>
