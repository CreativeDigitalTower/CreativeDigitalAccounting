  ...
  return (
    <>
        ...
        >
          <div style={{ background: "#0866FF", color: "#fff", padding: "16px 18px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <button onClick={() => setOpen(false)} aria-label="Затвори" style={{ background: "rgba(255,255,255,.2)", border: "none", color: "#fff", borderRadius: 6, width: 24, height: 24, cursor: "pointer" }}>×</button>
            </div>
            <div style={{ fontSize: 12.5, opacity: 0.9, marginTop: 2 }}>Обикновено отговаряме за минути</div>
          </div>
      ...
      >
        ...
        <span className="fb-label">{open ? "Затвори" : "Пишете ни"}</span>
      </button>
    </>
  );
}
