...
export const PLAN_DETAILS: Plan[] = [
  ...
  { id: "start", Icon: IconRocket, name: "Старт", tagline: "За малки фирми с активна ежедневна работа", price: 9, regularPrice: 15,
    ...
    features: ["До 30 документа месечно", "Всичко от Free", "Разходи и входящи документи", "Прикачване на файлове към разходи", "Повтарящи се фактури", "Напомняния за плащания", "Стандартни анализи", "Базов архив", "Фирмено лого във фактурите", "3 PDF шаблона", "1 потребител + 1 гост"],
