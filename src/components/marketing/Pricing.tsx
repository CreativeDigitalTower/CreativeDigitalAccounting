...
export const PLAN_DETAILS: Plan[] = [
  { id: "free", Icon: IconSeed, name: "Безплатен", tagline: "За стартиращи фирми и свободни професии", price: 0, regularPrice: 0,
    ...
    features: ["До 5 документа месечно", "1 фирма", "1 потребител", "Фактури, проформи и оферти", "До 5 клиенти и доставчици", "Базов склад", "Основно финансово табло", "Данъчен календар", "Двойно EUR/BGN обозначаване", "2 PDF шаблона"],
  ...
  { id: "start", Icon: IconRocket, name: "Старт", tagline: "За малки фирми с активна ежедневна работа", price: 9, regularPrice: 15,
    ...
    features: ["До 30 документа месечно", "Всичко от Free", "Разходи и входящи документи", "Прикачване на файлове към разходи", "Повтарящи се фактури", "Напомняния за плащания", "Стандартни анализи", "Симулация на цените (приходи и склад)", "Базов архив", "Фирмено лого във фактурите", "3 PDF шаблона", "1 потребител + 1 гост"],
  ...
  { id: "business", Icon: IconTrophy, name: "Бизнес", tagline: "За развиващи се компании", price: 29, regularPrice: 39,
    blurb: "Най-печелившият пакет с пълен набор от модули.",
    features: ["До 300 документа месечно", "Всичко от Старт", "Пълен склад", "Производство и себестойност", "Договори", "Проекти", "Активи и амортизации", "Служители и отпуски", "Портал за служители (самообслужване)", "Project Management (задачи по фирми, за екипи)", "HACCP / технологична документация", "Над 100 шаблона за бизнес документи", "Пълен архив", "Разширени анализи и KPI", "Роли и права", "До 5 потребители", "Всички PDF шаблони"],
  ...
  { id: "pro", Icon: IconCrown, name: "Про", tagline: "За компании, които искат максимална автоматизация", price: 59, regularPrice: 79,
    ...
    features: ["Неограничени документи", "Всичко от Бизнес", "Над 100 шаблона за бизнес документи", "Неограничени потребители", "Многофирмен режим", "API достъп", "AI CFO Assistant (при активиране)", "White Label възможности", "Персонализирани PDF шаблони", "Приоритетна поддръжка", "Ранен достъп до нови функции"],
