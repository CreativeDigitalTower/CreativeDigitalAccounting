...
export const PLAN_DETAILS: Plan[] = [
  ...
  { id: "business", Icon: IconTrophy, name: "Бизнес", tagline: "За развиващи се компании", price: 29, regularPrice: 39,
    ...
    features: ["До 300 документа месечно", "Всичко от Старт", "Пълен склад", "Производство и себестойност", "Договори", "Проекти", "Активи и амортизации", "Служители и отпуски", "HACCP / технологична документация", "Пълен архив", "Разширени анализи и KPI", "Роли и права", "До 5 потребители", "Всички PDF шаблони"],
  ...
  { id: "pro", Icon: IconCrown, name: "Про", tagline: "За компании, които искат максимална автоматизация", price: 59, regularPrice: 79,
    ...
    features: ["Неограничени документи", "Всичко от Бизнес", "Неограничени потребители", "Многофирмен режим", "API достъп", "AI CFO Assistant (при активиране)", "White Label възможности", "Персонализирани PDF шаблони", "Приоритетна поддръжка", "Ранен достъп до нови функции"],
