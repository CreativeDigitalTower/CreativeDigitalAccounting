...
export const PLAN_DETAILS: Plan[] = [
  ...
  { id: "business", Icon: IconTrophy, name: "Бизнес", tagline: "За развиващи се компании", price: 29, regularPrice: 39,
    ...
    features: ["До 300 документа месечно", "Всичко от Старт", "Пълен склад", "Производство и себестойност", "Договори", "Проекти", "Активи и амортизации", "Служители и отпуски", "HACCP / технологична документация", "Над 100 шаблона за бизнес документи", "Пълен архив", "Разширени анализи и KPI", "Роли и права", "До 5 потребители", "Всички PDF шаблони"],
