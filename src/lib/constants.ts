...
// Поддържани ставки ДДС в цялата платформа. 20/9/0 = BG; 18 = Северна Македония (§3).
// Единствен източник за dropdown-ите (нов документ, редакция) — без hardcode в JSX.
export const VAT_RATES = [20, 18, 9, 0] as const;
